...
export default async function SummaryPage( props : { params: Promise<{ id: string }>; }) {
    ...
    return (
        <div>
            <div className="blob"/>
            <div className="relative isolate min-h-screen bg-linear-to-br from bg-purple-100/40 to white">
                <div className="container mx-auto flex flex-col gap-4">
                    <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-24">
                        <div className="flex flex-col">
                            <SummaryHeader title={title} created_at={created_at} word_count={word_count}/>
                        </div>
